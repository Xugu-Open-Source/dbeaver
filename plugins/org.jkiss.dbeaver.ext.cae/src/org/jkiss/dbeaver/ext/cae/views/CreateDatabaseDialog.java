 ...
 */
package org.jkiss.dbeaver.ext.cae.views;
...
import org.jkiss.dbeaver.ext.cae.model.Charset;
import org.jkiss.dbeaver.ext.cae.model.Collation;
...
public class CreateDatabaseDialog extends BaseDialog {
	...
	public CreateDatabaseDialog(Shell parentShell, DataSource dataSource) {
	...
	protected Composite createDialogArea(Composite parent) {
		...
		for (Charset cs : dataSource.getCharsets()) {
		...
		for (Collation col : charset.getCollations()) {
