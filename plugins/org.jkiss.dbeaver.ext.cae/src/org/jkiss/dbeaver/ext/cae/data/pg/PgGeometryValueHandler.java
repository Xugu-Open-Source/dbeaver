 ...
 */
public class PgGeometryValueHandler extends JDBCAbstractValueHandler {
	
    public static final PgGeometryValueHandler INSTANCE = new PgGeometryValueHandler();

    private static final Log log = Log.getLog(PgGeometryValueHandler.class);
