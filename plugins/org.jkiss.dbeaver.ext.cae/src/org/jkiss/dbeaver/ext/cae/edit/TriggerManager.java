...
import org.jkiss.dbeaver.ext.cae.model.ObjectValidateAction;
...
import org.jkiss.dbeaver.ext.cae.model.TriggerTest;
	...
	static class TriggerDialog extends Dialog {
		...
		private void updateColumnTable(Composite parent, String[] tableHeader) {
			...
			if (colList.size() != 0) {
				...
				while (it.hasNext()) {
					org.jkiss.dbeaver.ext.cae.model.TableColumn col = (org.jkiss.dbeaver.ext.cae.model.TableColumn) it.next();
