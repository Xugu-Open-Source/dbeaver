...
import org.jkiss.dbeaver.ext.cae.model.*;
		...
		return new UITask<TableConstraint>() {
			...
			protected TableConstraint runTask() {
				EditConstraintPage editPage = new EditConstraintPage(Messages.edit_constraint_manager_dialog_title,
						parent, new DBSEntityConstraintType[] { DBSEntityConstraintType.PRIMARY_KEY,
								DBSEntityConstraintType.UNIQUE_KEY, DBSEntityConstraintType.CHECK },
						true);
				if (!editPage.edit()) {
					return null;
				}
