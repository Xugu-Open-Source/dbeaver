...
public class MySQLUserEditorPrivileges extends MySQLUserEditorAbstract
{
    ...
    public synchronized void activatePart()
    {
        ...
        isLoaded = true;
        LoadingJob.createService(
            new DatabaseLoadService<List<MySQLPrivilege>>(MySQLUIMessages.editors_user_editor_privileges_service_load_privileges, getExecutionContext()) {
                @Override
    ...
    private class PageControl extends UserPageControl {
        ...
        public ProgressVisualizer<List<MySQLPrivilege>> createPrivilegesLoadVisualizer() {
