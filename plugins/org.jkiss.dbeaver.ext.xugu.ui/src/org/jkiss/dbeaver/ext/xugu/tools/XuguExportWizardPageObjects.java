...
class XuguExportWizardPageObjects extends XuguWizardPageSettings<XuguExportWizard>
{
    ...
    public void createControl(Composite parent)
    {
        ...
        Group objectsGroup = UIUtils.createControlGroup(composite, XuguUIMessages.tools_db_export_wizard_page_settings_group_objects, 1, GridData.FILL_HORIZONTAL, 0);
