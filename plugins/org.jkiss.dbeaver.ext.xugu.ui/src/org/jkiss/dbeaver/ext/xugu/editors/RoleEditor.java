...
public class RoleEditor extends AbstractDatabaseObjectEditor<Role> {
	...
	public void createPartControl(Composite parent) {
		...
		Composite roleGroup = UIUtils.createTitledComposite(cf1,
		...
		Composite roleGroup2 = UIUtils.createTitledComposite(cf1, Messages.editors_authority_editor_database_title, 1,
				GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 400);
		roleGroup2.setSize(200, 200);
		Composite roleGroup3 = UIUtils.createTitledComposite(cf1, Messages.editors_authority_editor_object_title, 2,
				GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 400);
