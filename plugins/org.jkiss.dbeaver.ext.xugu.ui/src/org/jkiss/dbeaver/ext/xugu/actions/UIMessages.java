...
public class UIMessages extends NLS {
	static final String BUNDLE_NAME = "org.jkiss.dbeaver.ext.xugu.actions.UIMessages";
	...
	public static String edit_data_type_manager_dialog_title;
	public static String edit_foreign_key_manager_dialog_title;
	public static String edit_index_manager_dialog_title;
	public static String edit_package_manager_dialog_title;
	public static String edit_schema_manager_dialog_title;
	public static String edit_trigger_manager_dialog_title;
	public static String editors_session_editor_action__session;
	...
	public static String editors_source_abstract_editor_action_name;
	public static String editors_source_abstract_editor_state;
	...
	public static String views_compiler_dialog_no_source_object;
	public static String views_compiler_log_viewer_action_clear_log;
	public static String views_compiler_log_viewer_action_copy;
	public static String views_compiler_log_viewer_action_select_all;
	public static String views_compiler_log_viewer_column_line;
	public static String views_compiler_log_viewer_column_message;
	public static String views_compiler_log_viewer_column_pos;
	
	public static String dialog_connection_properties;
	public static String dialog_connection_properties_discription;
	...
	public static String pref_page_checkbox_disable_escape_processing;
	public static String pref_page_checkbox_enable_dbms_output;
	public static String pref_page_checkbox_use_rowid_to_identify_rows;
	public static String pref_page_checkbox_read_all_synonyms;
	public static String pref_page_label_by_default_plan_table;
	public static String pref_page_label_disable_client_side_parser;
	public static String pref_page_label_if_unchecked_java_classes;
	public static String pref_page_label_plan_table;
	public static String pref_page_legend_executin_plan;
	public static String pref_page_legend_misc;
