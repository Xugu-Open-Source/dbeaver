...
public class AuthorityEditor {
	...
	public void loadObjectAuthorityView(BaseGlobalObject owner) {
		// 加载组件
		subloginGroupLeft = UIUtils.createTitledComposite(parent2, Messages.editors_authority_editor_subTitle1, 1,
				GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 400);
		subloginGroupRight = UIUtils.createTitledComposite(parent2, Messages.editors_authority_editor_subTitle2, 1,
				GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 400);
