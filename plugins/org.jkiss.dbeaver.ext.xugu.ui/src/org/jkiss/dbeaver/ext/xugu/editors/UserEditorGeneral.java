...
public class UserEditorGeneral extends BaseUserEditor {
	...
	public void createPartControl(Composite parent) {
		...
		if (newUser) {
			...
			Composite userAttributeGroupLeft = UIUtils.createTitledComposite(pageControl,
			...
			Composite userAttributeGroupLeft = UIUtils.createTitledComposite(userAttibuteContainer,
					Messages.editors_user_editor_general_label_user_properties_title, 2,
					GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 0);
			userNameText = UIUtils.createLabelText(userAttributeGroupLeft, Messages.editors_user_editor_general_label_user_name, userName);
			ControlPropertyCommandListener.create(this, userNameText, UserPropertyHandler.NAME);
			...
			Composite userAttributeGroupRight = UIUtils.createTitledComposite(userAttibuteContainer,
...
//						}
			...
			Composite databaseAuthorityGroup = UIUtils.createTitledComposite(tabFolder, Messages.editors_authority_editor_database_title, 1,
					GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 0);
			...
			Composite objectAuthorityGroup = UIUtils.createTitledComposite(tabFolder, Messages.editors_authority_editor_object_title, 2,
					GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 0);
