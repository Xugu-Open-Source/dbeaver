 ...
 *
 */
public class ObjectAdapter implements IAdapterFactory {
    ...
    public Class[] getAdapterList() {
        return new Class[] { SourceObject.class, ProcedurePackaged.class, DBPScriptObjectExt.class, SchedulerJob.class };
    }
}
