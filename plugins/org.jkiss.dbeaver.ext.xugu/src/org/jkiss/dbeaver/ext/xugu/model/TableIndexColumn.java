...
public class TableIndexColumn extends AbstractTableIndexColumn {
	...
	public TableIndexColumn(TableIndex index, TableColumn tableColumn, int ordinalPosition, boolean ascending,
	...
	TableIndexColumn(TableIndex index, TableColumn tableColumn) {
		this.index = index;
		this.tableColumn = tableColumn;
	...
	@Override
	public TableIndex getParentObject() {
		return index;
	}
