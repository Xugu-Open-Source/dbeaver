 ...
 * 加载数据源信息
 */
public class DataSourceProvider extends JDBCDataSourceProvider<DataSource> implements DBPNativeClientLocationManager {
	...
	@NotNull
	@Override
	public DataSource openDataSource(@NotNull DBRProgressMonitor monitor, @NotNull DBPDataSourceContainer container)
			throws DBException {
