...
public class GeometryValueHandler extends JDBCAbstractValueHandler {
    ...
    public static final GeometryValueHandler INSTANCE = new GeometryValueHandler();

    private static final Log log = Log.getLog(GeometryValueHandler.class);
    ...
    protected void bindParameter(JDBCSession session, JDBCPreparedStatement statement, DBSTypedObject paramType, int paramIndex, Object value) throws DBCException, SQLException {
        ...
        } else if (value.getClass().getName().equals(Constants.XUGU_GEOMETRY_CLASS)) {
