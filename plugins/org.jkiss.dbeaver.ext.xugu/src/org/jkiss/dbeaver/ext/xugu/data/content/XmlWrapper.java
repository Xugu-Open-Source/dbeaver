...
public class XmlWrapper implements SQLXML {
	...
	public void free() throws SQLException {
		try {
			...
			throw new SQLException("Close XMLType failed", e);
		}
	}
	...
	public OutputStream setBinaryStream() throws SQLException {
		throw new SQLException("Unsupported binary stream");
	}
	...
	public Writer setCharacterStream() throws SQLException {
		throw new SQLException("Unsupported character stream");
	}
	...
	public void setString(String value) throws SQLException {
		throw new SQLException("Unsupported string");
	}
	...
	public <T extends Result> T setResult(Class<T> resultClass) throws SQLException {
		throw new SQLException("Unsupported set resultset");
	}
