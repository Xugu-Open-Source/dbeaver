...
public class ProcedureParameter implements DBSProcedureParameter, DBSTypedObject {
	...
	private List<ProcedureParameter> attributes;

	public ProcedureParameter(DBRProgressMonitor monitor, BaseProcedure procedure, String name, String datatype,
	...
	public ProcedureParameter(DBRProgressMonitor monitor, BaseProcedure procedure, ResultSet dbResult) {
		this.procedure = procedure;
		if (dbResult != null) {
	...
	@Override
	public BaseProcedure getParentObject() {
		return procedure;
	}
	...
	@Association
	public Collection<ProcedureParameter> getAttributes() {
		return attributes;
	}

	void addAttribute(ProcedureParameter attribute) {
		if (attributes == null) {
